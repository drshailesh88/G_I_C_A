...
- [ ] Req 8B-3: GitHub Actions CI pipeline — .github/workflows/ci.yml: type check, lint, test, build on push/PR. Node 20.x, cache node_modules, mock env vars for build. Fail fast on type check failure.
